    ...
    fn create_worktree(
        ...
        async move {
            ...
            let branch_name = match &target {
                CreateWorktreeTarget::ExistingBranch { branch_name } => branch_name.clone(),
                CreateWorktreeTarget::NewBranch { branch_name, .. } => branch_name.clone(),
            };
            ...
            fs.with_git_state(&dot_git_path, false, {
                ...
                move |state| {
                    ...
                    } else if !state.branches.contains(&branch_name) {
            ...
            let (ref_name, sha, create_branch_ref) = match target {
